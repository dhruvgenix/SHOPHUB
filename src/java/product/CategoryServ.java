...
public class CategoryServ extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String catdesp=request.getParameter("catdesp");
               System.out.println("yes"+catname);
        System.out.println("yes"+catdesp);
        UserDAOImp objj=new UserDAOImp();
      boolean res= objj.insertcategory(catname, catdesp);
