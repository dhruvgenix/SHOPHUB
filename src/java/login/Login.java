...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        System.out.println("Inside LOGIN CONTROLLERRRR");
        String page = "";
        ...
        if (userDTO.getName() == null) {
            ...
            if(userDTO.utype.equalsIgnoreCase("admin")){
            System.out.println("inside admin if==  "+userDTO.utype);
            response.sendRedirect("Adminn.jsp");
            }
            else{
                
                System.out.println("else other than admin=== "+userDTO.utype);
